...
type SubmitAnswersResponse struct {
	...
	BetterThan    int32                  `protobuf:"varint,2,opt,name=better_than,json=betterThan,proto3" json:"better_than,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_api_qstnnr_proto_rawDesc = []byte{
	...
	0x74, 0x74, 0x65, 0x72, 0x5f, 0x74, 0x68, 0x61, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52,
